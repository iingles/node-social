      ...
      <v-col cols="12" xs="9" sm="9" md="6" lg="4">
        <v-card class="pa-10">
          ...
          <v-form @submit.prevent="signUpHandler" @keyup.enter="signUpHandler" ref="signUpForm">
            <v-text-field v-model.lazy="firstName" label="First Name" :rules="nameRules"></v-text-field>
            <v-text-field v-model.lazy="lastName" label="Last Name" :rules="nameRules"></v-text-field>
            <v-text-field v-model.lazy="email" label="E-Mail Address" :rules="emailRules"></v-text-field>
            <v-text-field
            ...
            <v-text-field
              ...
              :rules="passwordRules"
            ></v-text-field>
            <v-btn @click="signUpHandler" type="submit" rounded color="blue" dark>Submit</v-btn>
          </v-form>
        </v-card>
        <p>
          Have an account?
