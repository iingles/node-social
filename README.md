...
1. ### Mongoose as my data modeling tool: 
...
4. ### At least 1 enpoint allowing user to update an item via PUT or PATCH:
...
7. ### Your app will be deployed to production using some service like Heroku, Digital Ocean, etc.
...
9. ### Your ReadMe file will accurately describe the server install process (if any) and how to use the APIs
